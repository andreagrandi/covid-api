import argparse
from covidapi import import_data_jh, import_regions_jh
...
parser_regions = subparsers.add_parser('jh_regions', description='Import the John Hopkins CSSE lookup table into the jh_region_info table', help='Import John Hopkins CSSE region information')

parser_jh_import = subparsers.add_parser('jh', description='Import John Hopkins CSSE daily reports into the database', help='Import John Hopkins CSSE daily reports')
...
parser_regions.set_defaults(func=import_regions_jh.main)
